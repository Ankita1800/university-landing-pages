...
async function loadFees() {
    try {
        ...
        console.log('🔄 Fetching fees from:', `${API_BASE_URL}/api/fees/mit`);
        ...
        feesContent.innerHTML = `<div class="p-8 text-center">
            ...
            <button onclick="loadFees()" class="bg-mit-red text-white px-6 py-2 rounded-lg hover:bg-mit-red/90 transition-colors">
                Retry
            </button>
            <p class="text-xs mt-4 text-gray-500">API Endpoint: ${API_BASE_URL}/api/fees/mit</p>
        </div>`;
    }
}
